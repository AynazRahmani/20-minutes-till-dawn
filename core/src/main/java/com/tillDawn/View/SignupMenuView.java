...
//        table.row().pad(10,0,10,0);
//
//        table.add(new Label("security question:", controller.getSkin()));
//        table.row();
//        table.add(questionBox).width(1000);
//        table.row().pad(10,0,10,0);
//
//        table.add(new Label("answer:", controller.getSkin()));
//        table.row();
//        table.add(answerField).width(700);
//        table.row().pad(20,0,20,0);
//
//        table.add(signupButton).pad(20,0,10,0);
//        table.row();
//        table.add(skipButton).pad(10,0,10,0);
//        table.row();
//        table.add(signinButton).pad(10,0,20,0);
//
//        table.row();
...
//
//        table = new Table();
//        table.top(); // محتوا از بالا شروع بشه
//
//        table.padTop(30); // کمی فاصله از بالا
//        table.defaults().pad(10).width(700);
//
...
//        table.row();
//
//        table.add(new Label("security question:", controller.getSkin())).left();
//        table.row();
//        table.add(questionBox).width(1000);
//        table.row();
//
//        table.add(new Label("answer:", controller.getSkin())).left();
//        table.row();
//        table.add(answerField);
//        table.row();
//
...
//        table.row();
//        table.add(signinButton).padBottom(20);
//        table.row();
//
//        errorLabel.setWrap(true);
//        errorLabel.setAlignment(Align.center);
//        table.add(errorLabel).width(700);
//        table.row();
//
//        table.pack(); // خیلی مهم: اندازه‌ی واقعی جدول رو مشخص کن
//
//        ScrollPane scrollPane = new ScrollPane(table, controller.getSkin());
//        scrollPane.setFillParent(true);
//        scrollPane.setScrollingDisabled(true, false); // فقط عمودی
//
